...
- [ ] `claim`, `certainty` and `report` match `docs/rules/python.md` exactly
...
Reviewed against `docs/criteria/python.md` (see `docs/criteria/README.md`) — the same document the tool
