...
[`../phases/05-measurement-study/PHASE.md`](../phases/05-measurement-study/PHASE.md):
...
Requires the architecture in [`../design/03-effect-architecture.md`](../design/03-effect-architecture.md).
...
[`../phases/02-fact-model/PHASE.md`](../phases/02-fact-model/PHASE.md).
...
support. See [`../phases/02-fact-model/PHASE.md`](../phases/02-fact-model/PHASE.md).
...
[`../phases/05-measurement-study/PHASE.md`](../phases/05-measurement-study/PHASE.md) §4 for
...
[`../design/02-evaluation-model.md`](../design/02-evaluation-model.md) §5 have
...
[`../design/02-evaluation-model.md`](../design/02-evaluation-model.md) §6 and
enforced by a snapshot test.

**120 is a vocabulary target, not a launch target.** See
[`../phases/04-pilot-rules/PHASE.md`](../phases/04-pilot-rules/PHASE.md) for what
actually ships.
