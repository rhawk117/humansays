...
```
docs/site/style-guide/python.md     Python Code Design and Review Criteria
docs/site/style-guide/rust.md       Rust Code Design and Review Criteria
```

These are the source of truth for every rule citation. `docs/site/rules/python.md`
cites section numbers from `python.md`; CI validates that every rule has a
citation and reports sections with zero coverage.

They are referenced by `.agent-specs/process/review-checklist.md` §7, which reviews the
